...
**Note:** Due to a bug in the current implementation, the function may retry infinitely on failure instead of stopping after the specified number of attempts.